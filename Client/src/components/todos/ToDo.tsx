...
export function ToDo({ toDo, onClick }: ToDoProps) {
  return (
    <div
      className="flex flex-col bg-fuchsia-400 p-4 min-h-48 max-h-48 min-w-40 max-w-40 gap-2 justify-between shadow-md shadow-black"
      onClick={() => {
        onClick(toDo.id);
      }}
    >
