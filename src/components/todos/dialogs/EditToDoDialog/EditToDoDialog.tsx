...
export function EditToDoDialog({ defaultValues, onSubmit, onArchive, ...rest }: EditToDoDialog) {
   const {
      errors,
      formIsTouched,
      formIsValid,
               ...
               <FieldGroup>
                  <Field>
                     ...
                     <Input
                        ...
                        placeholder={errors.title ? 'Title field is required' : undefined}
                        defaultValue={defaultValues.title}
                     />
                  </Field>
                  <Field>
                     <Label htmlFor="body">Body</Label>
                     <Input id="body" name="todo_body" onBlur={validateBody} defaultValue={defaultValues.body} />
                  </Field>
