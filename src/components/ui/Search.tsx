...
import { useEffect, useState, type ComponentProps, type InputEvent } from 'react';
...
export function Search({ onInput, debounceDelay = 0, ...rest }: SearchProps) {
   ...
   const handleInput = (e?: InputEvent<HTMLInputElement>) => setSearchTerm(e?.currentTarget.value.trim() ?? null);
