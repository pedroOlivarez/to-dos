...
export function ToDos(props: ComponentProps<'div'>) {
   ...
   return (
      <>
         <div className={cn('flex flex-col min-h-full w-full p-2 pr-18 sm:items-start  items-center', props.className)}>
            <ResultDisplay onSelectToDo={handleSelectToDo} toDos={data} isLoading={isLoading} isError={isError} />
         </div>
